...
PROMPTS_FILE="${PROMPTS_FILE:-evaluation/benchmarks/t2i_compbench/spatial_val.txt}"
OUTPUT_DIR="${OUTPUT_DIR:-outputs/eval/${MODEL}_t2i_compbench_spatial_val_dryrun}"
