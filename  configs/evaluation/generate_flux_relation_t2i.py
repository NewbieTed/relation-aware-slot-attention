...
DEFAULT_BACKGROUND_PROMPT = (
    "complete natural scene with a contextually appropriate background and visible ground, "
    "not isolated on a plain white background"
)
...
def make_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--background-prompt",
        type=str,
        default=DEFAULT_BACKGROUND_PROMPT,
        help="Generation-only background/setting text appended after the bound relation prompt.",
    )
    parser.add_argument(
        "--style-prompt",
        type=str,
