...
REGION_SLOT_LOSS_WEIGHT="${REGION_SLOT_LOSS_WEIGHT:-0.0}"
REGION_SLOT_TARGET="${REGION_SLOT_TARGET:-0.05}"
...
CMD=(
  ...
  --region-slot-loss-weight "$REGION_SLOT_LOSS_WEIGHT"
  --region-slot-target "$REGION_SLOT_TARGET"
