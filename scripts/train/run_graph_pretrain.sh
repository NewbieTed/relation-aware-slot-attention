...
GRAPH_LEARNING_RATE="${GRAPH_LEARNING_RATE:-1e-4}"
...
RELATION_LOSS_WEIGHT="${RELATION_LOSS_WEIGHT:-8.0}"
EMBEDDING_LOSS_WEIGHT="${EMBEDDING_LOSS_WEIGHT:-0.0}"
...
CMD=(
  ...
  --box3d-loss-weight "$BOX3D_LOSS_WEIGHT"
)
